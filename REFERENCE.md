...
Use `scripts/firefox-use.py` for Firefox. It speaks local W3C WebDriver through an
installed geckodriver and keeps the same deterministic, index-based workflow.
